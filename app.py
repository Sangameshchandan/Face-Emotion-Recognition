...
try:
    ...
    model =load_model('Modelweights (2).h5')  #Load model
...
def main():
    ...
    <style>#"This app is created by Sangamesh chandankera" {text-align: center}</style>
    </div>
    </body>
    """
    ...
    st.write("This app is created by Sangamesh chandankera")
